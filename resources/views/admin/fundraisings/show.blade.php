        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                @if (!$fundraising->is_active)
                        ...
                        @if ($fundraising->is_active)
                            <span class="text-white font-bold bg-green-500 rounded-2xl w-full p-5">Fundraising
                                telah disetujui oleh admin</span>
                        @else
                            <span class="text-white font-bold bg-red-500 rounded-2xl w-full p-5">Fundraising
                ...
                <div class="item-card flex flex-row gap-y-10 justify-between items-center">
                    ...
                    <div class="flex flex-row items-center gap-x-3">
                        ...
                        <form action="{{ route('admin.fundraisings_withdrawal.activate_fundraising', $fundraising) }}"
                            method="POST">
                            @csrf
                            <button type="submit" class="font-bold py-4 px-6 bg-indigo-600 text-white rounded-full">
                                Approve Now
                            </button>
                        </form>
                        @else
                            <span href="#" class="font-bold py-4 px-6 bg-green-500 text-dark rounded-full cursor-default">
                                Approved
                            </span>
