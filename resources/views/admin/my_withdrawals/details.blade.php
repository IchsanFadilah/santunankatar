            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                    ...
                    <div class="flex flex-col gap-y-10">
                        ...
                        <div>
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">
                                {{ date_format($fundraisingWithdrawal->created_at, 'd M Y') }}
                            </h3>
                        </div>
                    </div>
                    <div>
                ...
                @if($fundraisingWithdrawal->has_sent)
                    ...
                    @if(!$fundraisingWithdrawal->has_received)
                        ...
                        <form action="{{ route('admin.fundraising_phases.store', $fundraisingWithdrawal->fundraising_id) }}"
                            ...
                            <div class="mt-4 w-fit">
                                ...
                                <x-text-input id="photo" class="mb-7 block mt-1 w-full" type="file" name="photo" required
