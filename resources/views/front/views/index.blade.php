...
@section('title', 'Karang Taruna Desa Cibuntu | Bersinar')
@section('content')
    <section class="max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-white overflow-x-hidden pb-[134px]">
            ...
            <nav class="pt-5 px-3 flex justify-between items-center">
                <div class="flex items-center gap-[10px]">
                    ...
                    <div class="flex flex-col text-white">
                        <p class="text-xs leading-[18px]">Desa Cibuntu</p>
                        <p class="font-semibold text-sm">Bogor, Indonesia</p>
                    </div>
                </div>
        ...
        <div id="best-choices" class="mt-8 -mb-6">
            <div class="px-4 flex justify-between items-center">
                <h2 class="font-bold text-lg">Karang Taruna Desa Cibuntu <br>Peduli Anak Yatim</h2>
                {{-- <a href="" class="p-[6px_12px] rounded-full bg-[#E8E9EE] font-semibold text-sm">Li</a> --}}
            </div>
        ...
        {{-- <div id="menu"
            ...
            <a href="" class="p-[14px_16px] flex items-center gap-[6px] rounded-full bg-[#FF7815]">
                ...
                <span class="font-semibold text-sm text-white">Tentang</span>
            </a>
