    ...
    <section class="max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-white overflow-x-hidden">
        <div class="header flex flex-col bg-[#56BBC5] overflow-hidden h-[350px] relative -mb-[92px]">
            <nav class="pt-5 px-3 flex justify-between items-center relative z-20">
                ...
                <div class="flex flex-col items-center text-center">
                    ...
                    <p class="font-semibold text-sm text-white">#MariBersedekah</p>
                </div>
        ...
        <div class="flex flex-col z-30">
            ...
            @else
                <div id="status"
                    ...
                    <p class="font-semibold text-sm text-white">Semua Orang Layak Berbahagia</p>
                </div>
            @endif
            ...
            <div id="content" class="w-full bg-white rounded-t-[40px] flex flex-col gap-5 p-[30px_24px_120px]">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex items-center justify-between">
                        <p class="text-sm text-[#66697A]">Rp
                            {{ number_format($fundraising->totalReachedAmount(), 0, ',', '.') }}
                        </p>
                ...
                <div class="flex flex-col gap-[2px]">
                    <h2 class="font-semibold text-sm">Tentang</h2>
                ...
                <div class="flex flex-col gap-3">
                    <div class="flex items-center justify-between">
                        <h2 class="font-semibold text-sm">Donatur ({{ count($fundraising->donaturs) }})</h2>
        ...
        @if(!$goalReached)
            <a href="{{ route('front.support', $fundraising->slug) }}"
                class="p-[14px_20px] bg-[#76AE43] rounded-full text-white w-fit mx-auto font-semibold hover:shadow-[0_12px_20px_0_#76AE4380] transition-all duration-300 fixed bottom-[30px] transform -translate-x-1/2 left-1/2 z-40 text-nowrap">Berikan
                Donasi</a>
        @endif
    </section>
@endsection